...
export default function PropertyFilter() {
  ...
  return (
    <div className="relative max-w-[1100px] mx-auto -mt-24 px-5">
      {/* tab buttons */}
      <TabMenu
        data={tabmenus}
      ...
      {/* sales section */}
      {activeTab === "Sales" && (
        <div className="bg-white grid grid-cols-1 md:grid-cols-5 gap-2 py-7 px-7 rounded-md shadow-custom-blue">
          <div>
