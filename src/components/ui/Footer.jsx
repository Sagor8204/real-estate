...
export default function Footer() {
  return (
    <div className="py-20 bg-[#001a33] bg-fixed">
      <div className="max-w-[1200px] mx-auto grid grid-cols-4 text-white">
        <div className="col-span-2">
          <h2 className="mb-3">Contact us</h2>
          <ul className="text-gray-400">
            <li className="flex items-start text-[15px] gap-2 pb-2">
            ...
            <li className="flex items-center text-[15px] gap-2 pb-2">
              <FaPhoneAlt />
              <p>(305) 555-4446</p>
            </li>
            <li className="flex items-center text-[15px] gap-2 pb-2">
