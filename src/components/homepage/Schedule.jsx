...
export default function Schedule() {
  return (
    <div className={`py-24 bg-fixed bg-repeat ${styles.schedule_section}`}>
      {/* content */}
      <div className="z-[9999] px-5 lg:px-0">
        <h1 className="text-center text-[28px] lg:text-2xl font-semibold text-white pb-12">
          Contact us today if you’d like to know more <br /> about how we help
          buy, sell or rent your home
        </h1>

        <div className="bg-white max-w-[650px] mx-auto opacity-100 px-7 lg:px-14 py-10 rounded-md pointer-events-auto z-50">
          <div className="text-center mb-8">
            ...
            <p>
              ...
              <br className="hidden lg:relative" /> their expertise and insights
              to your real estate plans.
            </p>
          </div>

          <div className="flex flex-wrap lg:flex-nowrap items-center gap-3 lg:gap-2 mb-3">
            <input
